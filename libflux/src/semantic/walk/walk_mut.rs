...
impl<'a> NodeMut<'a> {
    ...
    pub fn replace_type(&mut self, sub: &Substitution) {
        match self {
            NodeMut::IdentifierExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::ArrayExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::FunctionExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::LogicalExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::ObjectExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::MemberExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::IndexExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::BinaryExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::UnaryExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::CallExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::ConditionalExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::StringExpr(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::IntegerLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::FloatLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::StringLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::DurationLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::UintLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::BooleanLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::DateTimeLit(ref mut n) => n.typ = n.typ.apply(sub),
            NodeMut::RegexpLit(ref mut n) => n.typ = n.typ.apply(sub),
            _ => (),
        }
    }
}

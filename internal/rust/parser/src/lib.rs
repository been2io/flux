...
#[no_mangle]
pub fn go_drop_string(s: *mut c_char) {
    unsafe {
        // Transfer to an owned string that will be dropped
        CString::from_raw(s);
    };
}
